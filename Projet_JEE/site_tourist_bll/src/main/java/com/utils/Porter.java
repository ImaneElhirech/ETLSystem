...
public class Porter {
	  ...
	  private String stripPrefixes ( String str) {
	     ...
	     String[] prefixes = {"ante","anti","circum","co","em","en","epi","ex","extra","homo","for","hyper","ir","infra","inter","intra","macro","micro","mid","mono","trans","omni","para","post","semi","tri","de", "dis", "ex", "il", "im", "in", "mis", "non", "pre","re","pro","super","uni","un"};
	  ...
	  public static void main(String[] args) {
		Porter p =new Porter();
		System.out.println(p.stripSuffixes("confortable"));
		//System.out.println(p.stripPrefixes("intouchable"));
		System.out.println(p.stripAffixes("absorbed"));
				}
